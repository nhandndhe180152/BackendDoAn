...
public interface IQRCodeService
{
    ...
    Task<byte[]> GenerateBulkPaddyLotLabelsPngZipAsync(List<int> ids, CancellationToken cancellationToken = default);
    Task<byte[]> GenerateBulkLocationLabelsPngZipAsync(List<int> ids, CancellationToken cancellationToken = default);
    Task<byte[]> GenerateBulkBagLabelsPngZipAsync(List<int> ids, CancellationToken cancellationToken = default);
    Task<QrResolveResponseDto> ResolveQrAsync(QrResolveRequestDto request, CancellationToken cancellationToken = default);
    QrLabelPreviewDto GetQrLabelPreviewSettings();
}
