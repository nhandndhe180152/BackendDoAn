...
public class CreateReturnToSupplierOrderStatusDtoValidator : AbstractValidator<CreateReturnToSupplierOrderStatusDto>
{
    public CreateReturnToSupplierOrderStatusDtoValidator()
    {
        RuleFor(x => x.Code)
            .NotEmpty()
            .MaximumLength(100)
