...
public class NotificationCategoryRepository : RepositoryBase<NotificationCategory, int>, INotificationCategoryRepository
{
    ...
    public NotificationCategoryRepository(BackendContext context, IUnitOfWork unitOfWork) : base(context, unitOfWork)
    {
        _context = context;
    }

    public async Task<DTResult<NotificationCategoryAggregate>> GetPagedAsync(DTParameter parameters)
    {
