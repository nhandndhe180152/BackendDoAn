...
public class ActionRepository : RepositoryBase<Domain.Entities.Action, int>, IActionRepository
{
    private readonly BackendContext _context;
    public ActionRepository(BackendContext context, IUnitOfWork unitOfWork) : base(context, unitOfWork)
    {
        _context = context;
    }

    public async Task<DTResult<ActionAggregate>> GetPagedAsync(DTParameter parameters)
    {
