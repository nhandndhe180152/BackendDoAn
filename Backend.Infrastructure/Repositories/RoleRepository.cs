...
public class RoleRepository : RepositoryBase<Role, int>, IRoleRepository
{
    ...
    public RoleRepository(BackendContext context, IUnitOfWork unitOfWork) : base(context, unitOfWork)
    {
        _context = context;
    }

    public async Task<DTResult<RoleAggregate>> GetPagedAsync(DTParameter parameters)
    {
