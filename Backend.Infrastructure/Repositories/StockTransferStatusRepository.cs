...
public class StockTransferStatusRepository : RepositoryBase<StockTransferStatus, int>, IStockTransferStatusRepository
{
    private readonly BackendContext _context;

    public StockTransferStatusRepository(BackendContext context, IUnitOfWork unitOfWork) : base(context, unitOfWork)
    {
        _context = context;
    }

    public async Task<DTResult<StockTransferStatusAggregate>> GetPagedAsync(DTParameter parameters)
    {
        ...
        var query = _context.StockTransferStatuses
            .Where(x => !x.IsDeleted)
        ...
        var data = new DTResult<StockTransferStatusAggregate>
        {
