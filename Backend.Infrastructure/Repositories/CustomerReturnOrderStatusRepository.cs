...
public class CustomerReturnOrderStatusRepository : RepositoryBase<CustomerReturnOrderStatus, int>, ICustomerReturnOrderStatusRepository
{
    private readonly BackendContext _context;

    public CustomerReturnOrderStatusRepository(BackendContext context, IUnitOfWork unitOfWork) : base(context, unitOfWork)
    {
        _context = context;
    }

    public async Task<DTResult<CustomerReturnOrderStatusAggregate>> GetPagedAsync(DTParameter parameters)
    {
        ...
        var query = _context.CustomerReturnOrderStatuses
            .Where(x => !x.IsDeleted)
            .Select(x => new CustomerReturnOrderStatusAggregate
            {
                Color = x.Color,
        ...
        var data = new DTResult<CustomerReturnOrderStatusAggregate>
        {
