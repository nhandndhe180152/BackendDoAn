...
public class MillingOrderStatusRepository : RepositoryBase<MillingOrderStatus, int>, IMillingOrderStatusRepository
{
    private readonly BackendContext _context;

    public MillingOrderStatusRepository(BackendContext context, IUnitOfWork unitOfWork) : base(context, unitOfWork)
    {
        _context = context;
    }

    public async Task<DTResult<MillingOrderStatusAggregate>> GetPagedAsync(DTParameter parameters)
    {
        ...
        var query = _context.MillingOrderStatuses
            .Where(x => !x.IsDeleted)
            .Select(x => new MillingOrderStatusAggregate
            {
                Color = x.Color,
        ...
        var data = new DTResult<MillingOrderStatusAggregate>
        {
