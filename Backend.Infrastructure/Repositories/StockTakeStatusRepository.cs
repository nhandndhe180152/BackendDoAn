...
public class StockTakeStatusRepository : RepositoryBase<StockTakeStatus, int>, IStockTakeStatusRepository
{
    private readonly BackendContext _context;

    public StockTakeStatusRepository(BackendContext context, IUnitOfWork unitOfWork) : base(context, unitOfWork)
    {
        _context = context;
    }

    public async Task<DTResult<StockTakeStatusAggregate>> GetPagedAsync(DTParameter parameters)
    {
        ...
        var query = _context.StockTakeStatuses
            .Where(x => !x.IsDeleted)
            .Select(x => new StockTakeStatusAggregate
            {
                Color = x.Color,
        ...
        var data = new DTResult<StockTakeStatusAggregate>
        {
