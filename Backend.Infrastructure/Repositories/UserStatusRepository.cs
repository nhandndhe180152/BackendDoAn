...
public class UserStatusRepository : RepositoryBase<UserStatus, int>, IUserStatusRepository
{
    ...
    public UserStatusRepository(BackendContext context, IUnitOfWork unitOfWork) : base(context, unitOfWork)
    {
        _context = context;
    }

    public async Task<DTResult<UserStatusAggregate>> GetPagedAsync(DTParameter parameters)
    {
